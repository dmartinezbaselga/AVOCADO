...
namespace RVO {
	...
	public:
		 ...
		 */
		size_t addAgent(const Vector2 &position, const float const_alpha = 0.5, const float a = 0.1, const float b = 0.,
						const float c = 1.0, const float d = 0.1, const float kappa = 1., const float epsilon = 2.,
						const float delta = 0.1, const float max_noise = 0.0);
		...
		size_t addAgent(const Vector2 &position, float neighborDist,
						...
						const float const_alpha = 0.5, const float a = 0.1, const float b = 0.,
						const float c = 1.0, const float d = 0.1, const float kappa = 1., 
						const float epsilon = 2., const float delta = 0.1, const float max_noise = 0.0);
		 ...
		 * \param      agentNo         The number of the agent whose
		 *                             info is requires.
		 * \param      neighbor        The number of the neighbor whose alpha is required.
		 */
